...
Create the databases and their tables. Run once on an empty board project,
before any process. It is outside the chain — see T3.1.

| Reads | Writes |
|---|---|
| `board-build-tool.md` — T1.2, T1.3 | `design.db` — `parts_table` |
